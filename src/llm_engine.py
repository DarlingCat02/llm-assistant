...
class LLMEngine:
    ...
    def __init__(self, config: LLMConfig | None = None):
        ...
        self._system_prompt = (
            ...
            "- app_open(name) — открыть приложение (notepad, telegram, chrome и др.)\n"
            "- file_open(path) — открыть файл ассоциированным приложением\n"
            "- Используй эти инструменты когда пользователь просит создать файл, открыть приложение или файл"
        )
